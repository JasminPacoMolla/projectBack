...
<head>
    ...
    <title>MDcreations - PassCode - Markdown</title>
                ...
                <div class="w-full">
                    <nav class="flex items-center justify-between py-4 navbar navbar-expand-lg">
                        <a class="navbar-brand mr-5" href="index.html">
                            <img src="assets/img/logo/logo-MD.svg" alt="Logo" />
                        </a>
        ...
        <div class="row flex items-center relative">
            <div class="w-full lg:w-1/2">
                <div class="hero-content mb-0 lg:mb-6">
                    <h1 class="text-black mb-9 text-4xl sm:text-5xl md:text-5xl lg:text-5xl xl:text-5xl 2xl:text-6xl">Enjoy and Create Amazing Documents with PassCode!</h1>
                    <p class="text-black text-lg mb-10 xl:pr-18 2xl:pr-120">
                        Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.
                    </p>
                    <a href="javascript:void(0)" class="main-btn  btn-hover mb-2">Get Started</a>
                    <!-- <a href="#features" class="scroll-bottom"> <i class="lni lni-arrow-down"></i></a> -->
                </div>
            </div>
            <div class="w-full lg:w-1/2">
                <div class="hero-img pt-8 lg:pt-0">
                    <img src="assets/img/logo/logo-CP.svg" alt="" class="w-full lg:w-auto">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row flex justify-center">
                <div class="w-full md:w-9/12 lg:w-8/12 xl:w-6/12">
                    <div class="section-title text-center mb-15">
                        <h1 class="mb-6">Why Choose PassCode</h1>
            ...
            <div class="testimonial-active">
                ...
                <div class="single-testimonial">
                    <div class="row flex">
                        <div class="w-full lg:w-5/12">
                            <div class="testimonial-img inline-block lg:block text-left lg:text-right relative mb-8 lg:mb-0">
                                <img src="assets/img/testimonial/testimonial-3.png" alt="" class="lg:ml-auto">
                                <div class="quote">
                                    <i class="lni lni-quotation"></i>
                                </div>
                            </div>
                        ...
                        <div class="lg:w-6/12">
                            <div class="content-wrapper">
                                <div class="content">
                                    <p class="text-lg leading-7 mb-8">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam, nulla velit! Neque nulla exercitationem earum?</p>
                                </div>
                                <div class="info">
                                    <h4 class="mb-3">Alfredo Díez</h4>
                                    <p>Student at Paco Molla</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- ========================= footer start ========================= -->
<footer class="footer bg-cover bg-no-repeat bg-right-top pt-120 mt-25 md:bg-transparent md:pt-260 lg:pt-260" style="background-image: url('assets/img/footer/footer-bg.svg');">
    <div class="container">
            ...
            <div class="row">
                ...
                <div class="w-full md:w-6/12 lg:w-4/12">
                    <div class="footer-widget mb-10 mx-3">
                        <div class="logo mb-8">
                            <a href="index"> <img src="assets/img/logo/logo-MDfooter.svg" alt=""> </a>
                        </div>
                        <!-- <p class="mb-8 text-black sm:pr-13 md:pr-0 2xl:pr-25">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed dinonumy eirmod tempor invidunt.</p> -->
                        <ul class="socials flex items-center">
                            ...
                            <li >
                                <a href="jvascript:void(0)"> <i class="lni lni-github-original"></i></i> </a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="w-full md:w-6/12 lg:w-2/12">
                    <div class="footer-widget mb-10 mx-3">
                        <h3 class="mb-6 text-black">About Us</h3>
                        <ul class="links">
                ...
                <div class="w-full md:w-6/12 lg:w-3/12">
                    <div class="footer-widget mb-10 mx-3">
                        <h3 class="mb-6 text-black">Features</h3>
                        <ul class="links">
                ...
                <div class="w-full md:w-6/12 lg:w-3/12">
                    <div class="footer-widget mb-10 mx-3">
                        <h3 class="mb-6 text-black">Other Products</h3>
                        <ul class="links">
